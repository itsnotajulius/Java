...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // just "East" and the program will move to the appropriate location if there is
        // one.
        // As at present, an attempt to move in an invalid direction should print a
        // message and remain in
        // the same place. Single letter commands (N, W, S, E, Q) should still be
        // available.
